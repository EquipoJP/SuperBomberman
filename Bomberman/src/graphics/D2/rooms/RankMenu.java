...
public class RankMenu extends Room {
	...
	public RankMenu(int w, int h, String n, Sprite background, Record record) {
		...
		if(this.record != null){
			...
			Sprite next = Initialization.getSpriteFromMenu(Initialization.BUTTONS.CONTINUE_BUTTON.toString());
			next.setSubimages(1);
			...
			Sprite back = Initialization.getSpriteFromMenu(Initialization.BUTTONS.BACK_BUTTON.toString());
			back.setSubimages(1);
