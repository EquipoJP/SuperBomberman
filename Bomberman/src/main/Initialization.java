...
public class Initialization {
	...
	public static enum SPRITES {
		...
		EXPLOSION_MID_UP, EXPLOSION_MID_DOWN, EXPLOSION_MID_LEFT, 
		EXPLOSION_MID_RIGHT, EXPLOSION_EDGE_UP, EXPLOSION_EDGE_DOWN, 
		EXPLOSION_EDGE_LEFT, EXPLOSION_EDGE_RIGHT
	};
