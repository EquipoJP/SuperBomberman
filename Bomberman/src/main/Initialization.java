...
public class Initialization {
	...
	public static enum BUTTONS{
		TITLE_BUTTON, GAME_BUTTON, OPTIONS_BUTTON, RANKING_BUTTON, CREDITS_BUTTON, QUIT_BUTTON, DIGITS, CONTINUE_BUTTON, NEW, BACK_BUTTON, LOADING
	};

	public static enum SPRITES {
		WHITE_BOMBER, BLUE_DOLL, PINK_DOLL, EXPLOSION_CORE, EXPLOSION_MID_VER, EXPLOSION_MID_HOR, EXPLOSION_EDGE_UP, EXPLOSION_EDGE_DOWN, EXPLOSION_EDGE_LEFT, EXPLOSION_EDGE_RIGHT, BOMB, DESTOYED_BOMB
	};
